				...
				<td width="100%">
					...
					<form method="post" action="/site/management/pages/add">
						...
						<select name="templateName">
							<option value="firstLevelPage">Home Page</option>
							<option value="firstLevelCarouselPage">Home Carousel Page</option>
							<option value="secondLevelPage">Promo Page</option>
							<option value="thirdLevelPage">Content Page</option>
						</select>
						<br/>
						Include Path: <input type="text" name="includePath"/><br/>
						<br/>
